...
router.get("/item/:id/delete", ensureLoggedIn(), item_controller.item_delete_get);

// POST request to delete item.
router.post("/item/:id/delete", ensureLoggedIn(), item_controller.item_delete_post);

// GET request to update item.
router.get("/item/:id/update", ensureLoggedIn(), item_controller.item_update_get);

// POST request to update item.
router.post("/item/:id/update", ensureLoggedIn(), item_controller.item_update_post);
...
router.get("/group/create", ensureLoggedIn(), item_group_controller.group_create_get);

//POST request for creating group.
router.post("/group/create", ensureLoggedIn(), item_group_controller.group_create_post);

// GET request to delete group.
router.get("/group/:id/delete", ensureLoggedIn(), item_group_controller.group_delete_get);

// POST request to delete group.
router.post("/group/:id/delete", ensureLoggedIn(), item_group_controller.group_delete_post);

// GET request to update group.
router.get("/group/:id/update", ensureLoggedIn(), item_group_controller.group_update_get);

// POST request to update group.
router.post("/group/:id/update", ensureLoggedIn(), item_group_controller.group_update_post);
...
router.get("/coupon/create", ensureLoggedIn(), coupon_controller.coupon_create_get);

//POST request for creating coupon.
router.post("/coupon/create", ensureLoggedIn(), coupon_controller.coupon_create_post);

// GET request to delete coupon.
router.get("/coupon/:id/delete", ensureLoggedIn(), coupon_controller.coupon_delete_get);

// POST request to delete coupon.
router.post("/coupon/:id/delete", ensureLoggedIn(), coupon_controller.coupon_delete_post);

// GET request to update coupon.
router.get("/coupon/:id/update", ensureLoggedIn(), coupon_controller.coupon_update_get);

// POST request to update coupon.
router.post("/coupon/:id/update", ensureLoggedIn(), coupon_controller.coupon_update_post);
